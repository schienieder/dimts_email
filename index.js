...
app.post('/send-email', cors(corsOptions), async (req, res) => {
  ...
  const emailConfig = {
    ...
    <head>
        ...
        <title>DIMTS Document Confirmation</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
    ...
    <body width="100%" style="margin: 0; padding: 2rem 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;">
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                <!-- <tr>
                    <td valign="middle" class="hero bg_white" style="padding: 0 0 2em 0;">
                        <img src="cid:email_img" alt="Email Image" style="width: 600px; max-width: 600px; height: auto; margin: auto; display: block;">
                    </td>
                </tr> -->
                <tr>
                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding: 0 2.5em;">
                                    ...
                                    <div style="width:100%;">
                                      <center>
                                        <h3 style="font-weight: 700;">${data.qr_tracker}</h3>
                                      </center>
                                    </div>
                                    <div style="text-align: right;">
                                        <h3 style="margin-top: 1rem; margin-bottom: -0.02rem; font-weight: 300;">Truthfully Yours,</h3>
                                        <h3 style="font-weight: 700;">DIMTS</h3>
                                    </div>
                                </div>
                            </td>
                        </tr>
  ...
  try {
    ...
    return res.json({data: { message: process.env.NODE_ENV === "production" ? "Something went wrong." : error.message}});
  }
});
